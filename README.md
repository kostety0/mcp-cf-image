...
[PolyForm Noncommercial 1.0.0](LICENSE.md) — некоммерческое использование.

Разрешено бесплатно: личное использование, учёба, исследования, хобби-проекты,
изменение кода и распространение форков — при условии сохранения текста лицензии
и строки копирайта.

**Любое коммерческое использование требует отдельного письменного разрешения
автора.** За коммерческой лицензией — через
[issues репозитория](https://github.com/kostety0/mcp-cf-image/issues).
